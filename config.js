...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "PIERRE CHEM GROUP (PTY) LTD",
    phone:     "+27 78 616 4641",
    whatsapp:  "+27 78 616 4641",
    address:   "1st Floor, METROPOLITAN PARK, 8 Hillside Rd, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "PIERRE CHEM GROUP (PTY) LTD — Pest control in johannesburg",
    description: "PIERRE CHEM GROUP (PTY) LTD provides professional pest control in Johannesburg. 3 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "PIERRE CHEM GROUP (PTY) LTD provides effective pest control for homes and businesses across Johannesburg. Cockroaches, rodents, ants, termites — we identify the problem and treat it at the source.",
    ...
    band: {
      ...
      alt:   "PIERRE CHEM GROUP (PTY) LTD team at work in Johannesburg",
